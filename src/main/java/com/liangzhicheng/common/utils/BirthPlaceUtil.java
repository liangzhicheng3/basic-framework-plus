...
public class BirthPlaceUtil {
    ...
    public static String getBirthPlace(String cardNo) {
        int cardCode = Integer.parseInt(cardNo);
        String province = getNameString(cardCode / 10000);
        String city = getNameString(cardCode / 100);
        String district = getNameString(cardCode);
        String birthPlace = "";
        if (ToolUtil.isNotBlank(province)) {
            birthPlace += province;
        }
        if (ToolUtil.isNotBlank(city)) {
            birthPlace += city;
        }
        if (ToolUtil.isNotBlank(district)) {
            birthPlace += district;
        }
        return birthPlace;
    }
     ...
     * @return String
     */
    private static String getNameString(int cardCode) {
        switch (cardCode) {
        case 11:
            return "北京市";
        case 1101:
