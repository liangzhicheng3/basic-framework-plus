...
public class FlywayTool {
    ...
    static String URL = "jdbc:mysql://127.0.0.1:3306/basic_framework_plus?useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&serverTimezone=Asia/Shanghai";
